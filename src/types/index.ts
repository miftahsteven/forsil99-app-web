...
export interface AlumniProfile {
  ...
  maritalStatus?: 'Belum Menikah' | 'Menikah' | 'Duda' | 'Janda' | string;
  hobbies?: string[];
  ...
  privacyRestriction?: 'none' | 'private' | 'followers_only';
  verifiedAt?: string;
...
export interface AppNotification {
  ...
  type: 'verification' | 'reaction' | 'comment' | 'chat' | 'shop' | 'event' | 'system' | 'follow' | 'profile_view';
  title: string;
  body: string;
  isRead: boolean;
  data?: any;
